        ...
        <div className="flex-1 min-w-0">
          ...
          {editing ? (
            <input
              ...
              style={{ borderColor: '#F5C200', color: '#fff' }}
            />
          ) : (
            <p
    ...
    <>
      ...
      <div className="min-h-screen pb-32" style={{ backgroundColor: '#2B2B2B', color: '#fff' }}>
        ...
        <div className="max-w-lg mx-auto px-4 pt-5 space-y-4">
              ...
              {[
                ...
                return (
                  <button
                    ...
                    className="relative rounded-xl py-3 px-4 text-left transition-all duration-200 border"
                    style={{
          ...
          {/* Spacer so content not hidden behind sticky CTA */}
          <div className="h-8" />
        </div>
      </div>
      ...
      {/* ── [6] STICKY BOTTOM CTA ─────────────────────────────────────────── */}
      <div
        className="fixed bottom-0 left-0 right-0 z-40 px-4 pb-6 pt-3 safe-bottom"
        style={{ backgroundColor: '#2B2B2B', borderTop: '1px solid #3D3D3D' }}
      >
        <button
          onClick={handlePlaceOrder}
          disabled={isDisabled}
          className="w-full py-4 rounded-xl font-black text-base tracking-wide transition-all duration-200 flex items-center justify-center gap-2"
          style={{
