...
const OrderForm: React.FC = () => {
  ...
  if (items.length === 0) {
    return (
      <section id="order" className="py-16 px-4 md:py-24 md:px-12 text-center relative bg-surface-2 border-t border-border/40">
        <div className="max-w-md mx-auto p-8 border border-dashed rounded-2xl animate-fade-slide-up border-border bg-bg/50">
          <span className="text-4xl">🛒</span>
          <h2 className="font-serif font-bold text-xl mt-4 text-heading">
            Your Cart is Empty
          </h2>
          <p className="text-sm mt-2 mb-6 leading-relaxed text-muted">
  ...
  if (!profile) {
    return (
      <section id="order" className="py-16 px-4 md:py-24 md:px-12 text-center relative bg-surface-2 border-t border-border/40">
        <div className="max-w-md mx-auto p-8 border rounded-2xl animate-fade-slide-up border-border bg-surface shadow-card">
          <span className="text-4xl animate-float" style={{ animationDuration: '4s' }}>👋</span>
          <h2 className="font-serif font-black text-2xl mt-4 text-heading">
            Sign In to Complete Your Order
          </h2>
          <p className="text-sm mt-2 mb-6 leading-relaxed font-sans text-muted">
