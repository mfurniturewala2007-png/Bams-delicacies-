  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div
        ...
        className="absolute inset-0 bg-[#0D0D0D]/70 backdrop-blur-sm transition-opacity duration-300 touch-none"
      />

      {/* ── MOBILE: bottom sheet (below sm breakpoint) ── */}
      <div className="sm:hidden absolute bottom-0 left-0 right-0 flex flex-col bg-surface rounded-t-3xl shadow-2xl max-h-[90vh]"
      ...
      >
        ...
        <div className="px-4 py-3 border-b border-border flex items-center justify-between flex-shrink-0">
          <h2 className="font-serif font-black text-xl text-heading flex items-center gap-2">
        ...
        {/* Items */}
        <div className="flex-grow overflow-y-auto scroll-smooth-ios px-4 py-3 space-y-3">
          {items.length === 0 ? (
            <div className="flex flex-col items-center justify-center text-center py-12 px-4">
              <span className="text-4xl mb-3">🍛</span>
              <h3 className="font-serif font-bold text-lg text-heading">Nothing here yet</h3>
      ...
      {/* ── DESKTOP: right panel (sm+) ── */}
      <div className="hidden sm:flex absolute inset-y-0 right-0 max-w-full pointer-events-none">
